...
void DebugOptions::save_to_file()
{
    Cool::Serialization::save<DebugOptions::Instance, cereal::JSONOutputArchive>(
        instance(),
        Cool::Path::user_data() / "debug-options-demo.json",
        "Debug Options");
}
...
auto DebugOptions::load_debug_options() -> Instance
{
    ...
    auto const err          = Cool::Serialization::load<DebugOptions::Instance, cereal::JSONInputArchive>(the_instance, Cool::Path::user_data() / "debug-options-demo.json");
